...
const Customstart = ({ data, isConnectable, selected }) => {
    let x =data.name
    let  y =data.progress;
    let z = data.color;
    if(z===undefined){
  ...
  return (
      <RecoilRoot> 
         ...
         <div className="grid place-items-center h-full text-xl ">
              ...
              <HoverCard className="fixed" >
  <HoverCardTrigger className=' dark:text-white p-4 top-6 text-2xl'>{name}<HoverCardContent className="grid place-items-center w-96 shadow-lg border-slate-200 ">
