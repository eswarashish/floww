    ...
    <div className="dark:bg-gray-900 bg-white py-4 fixed bottom-0 w-full rounded-t-md border border-slate-200 dark:border-slate-600  ">
      <div className=" px-2  flex flex-row justify-between ">
        <div className="flex items-center space-x-4">
          ...
          <Link className=" hover:text-gray-300" href="https://www.linkedin.com/in/k-eswar-ashish-a91947205/">
            <LinkedInLogoIcon className="h-6 w-6" />
            <span className="sr-only">LinkedIn</span>
          </Link>
        </div>
        <p className="mt-4 md:hidden lg:block text-sm">© 2024 KEA Inc. All rights reserved.</p>
      </div>
    </div>
  )
}
